            ...
            <div class="w-64 bg-gray-900 text-white h-screen">
                ...
                <nav class="mt-10">
                    ...
                    <div class="mt-4">
                        ...
                        <div
                            id="workshopMenu"
                            class="ml-4 hidden transition-all"
                        >
                            <a
                                href="{{ route('summary') }}"
                ...
                <div class="flex justify-between items-center mb-5">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="relative">
                            <button
                                id="userDropdownBtn"
                                class="mr-4 flex items-center focus:outline-none"
                            >
                                <span
                                    class="mr-2"
                                    >{{ Auth::user()->name }}</span
                    ...
                    <table class="min-w-full bg-white mt-3">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="py-2 px-4 text-center">
                                    {{ $equipment->productEquipmentType->name ?? '-' }}
                                </td>
                                <td class="py-2 px-4 text-center">
                                    {{ $equipment->sn }}
                                </td>
                                ...
                                <td class="py-2 px-4 text-center">
                                    {{--
                                    <a
                                        href="{{ url('form/'. $equipment->id) }}"
                                        class="workshopBtn bg-green-500 text-white px-4 py-2 rounded"
                                    >
                                        + Workshop Test
                                    </a>
                                    --}}
                                    <form
                                        action="{{ route('proses-qc.workshop-test', $equipment->id) }}"
                                        method="POST"
